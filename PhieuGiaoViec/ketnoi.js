/* ==========================================================================
   TỆP CẤU HÌNH HỆ THỐNG - FRONTEND (ketnoi.js)
   (Chứa toàn bộ thông tin định danh, liên kết của giao diện người dùng)
   ========================================================================== */
...
var PGV_TAC_GIA = "TPhát triển bởi\nHoàng Ngọc Lâm"; // Cập nhật đúng định dạng 2 dòng
